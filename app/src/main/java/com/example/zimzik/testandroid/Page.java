...
public class Page extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.plus).setOnClickListener(v -> sMyPagerAdapter.addPage(newInstance(++sPageNum, sMyPagerAdapter, sViewPager)));
        if (sPageNum == 1) {
            ...
            view.findViewById(R.id.minus).setOnClickListener(v -> {
                ...
                sViewPager.setCurrentItem(sPageNum - 1);
            });
        }
        return view;
    }
